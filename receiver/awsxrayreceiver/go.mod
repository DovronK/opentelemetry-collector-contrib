...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/proxy v0.133.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/xray v0.133.0
